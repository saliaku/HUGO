...
## Step 3: Initialize the Github repository
...
6. Commit the change to your local repository with a commit message of something like “Added workflow”, and push to GitHub.
```bash
    git add .
